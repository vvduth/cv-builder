...
const STEPS = [
  { title: "Add a pdf resume", text: "or create from scratch" },
          ...
          {STEPS.map(({ title, text }, index) => (
            <div className="relative self-start pl-14" key={index}>
              <dt className="text-lg font-bold">
                <div className="bg-primary absolute left-0 top-1 flex h-10 select-none w-10 items-center justify-center rounded-full p-[3.5px] opacity-80">
